...
RSpec.describe 'Home page' do
  ...
  describe 'amount section fields' do
  ...
  describe 'gift aid section fields' do
  ...
  describe 'payment information section fields' do
    it 'displays a payment type selector' do
      expect(last_response.body).to include('Credit card')
    end

    describe 'contact details section fields' do
    ...
    describe 'card details section fields' do
  ...
  it 'displays the submit button' do
    expect(page.css('button#submit').count).to be(1)
  end
end
